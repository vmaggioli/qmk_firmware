...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FUNC] = LAYOUT_planck_mit(
        ...
        _______, KC_PGUP, KC_PGDN, KC_HOME,  KC_END, _______, _______, KC_F11,  KC_F12,  _______, _______, _______,
    ...
    [_NUMS] = LAYOUT_planck_mit(
        ...
        _______,        , KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
